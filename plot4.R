...
with(powerconsum, plot(datetime, Global_active_power, type="l", xlab="datetime", ylab="Global Active Power"))

with(powerconsum, plot(datetime, Voltage, type="l", xlab="datetime", ylab="Voltage"))

with(powerconsum, plot(datetime, Sub_metering_1, type="l", ylab="Energy Submetering", xlab="datetime"))
...
with(powerconsum, plot(datetime, Global_reactive_power, type="l", xlab="datetime", ylab="Global Reactive Power"))
